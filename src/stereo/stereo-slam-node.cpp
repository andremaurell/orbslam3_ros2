    ...
    m_SLAM(pSLAM)
{
    ...
    left_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(this, "/freedom_vehicle/camera/image_raw");
    right_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(this, "/freedom_vehicle/camera2/image_raw");
