    ...
    SLAM_(SLAM)
{
    ...
    subImu_ = this->create_subscription<ImuMsg>("/freedom_vehicle/imu", 1000, std::bind(&StereoInertialNode::GrabImu, this, _1));
    subImgLeft_ = this->create_subscription<ImageMsg>("/freedom_vehicle/left/camera/image_raw", 100, std::bind(&StereoInertialNode::GrabImageLeft, this, _1));
    subImgRight_ = this->create_subscription<ImageMsg>("/freedom_vehicle/right/camera/image_raw", 100, std::bind(&StereoInertialNode::GrabImageRight, this, _1));
